...
public class CertificateRepositoryImpl implements CertificateRepository {
    ...
    static final String queryForUpdateRequest = "UPDATE certificate set name = ? WHERE name = ?";
    ...
    @Override
    public List<Certificate> getObjects(CertficateSpecification certficateSpecification) throws SQLException {
